...
**Команда:** (Ищенко Иоанн и Толстова Елена)
...
- Просмотр, добавление, редактирование и удаление записей (CRUD) для сущностей:
  ...
  - `jewelry` (Украшения), привязанные к категории (FK `category_id`)

---

## Как запустить приложение

### Быстрый запуск с использованием Docker 
...
- `ADMIN_USER`, `ADMIN_PASS` — настройки для входа в административную консоль GlassFish (по умолчанию `admin/admin`)
